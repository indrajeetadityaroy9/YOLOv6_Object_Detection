...
# Create directory structure for custom_dataset
...
# List to store all image and label paths
all_image_paths = []
all_label_paths = []
...
for breed_dir in tqdm(breed_dirs, desc='Processing breeds'):
    ...
    # Ensure breed_images_dir exists
    ...
    for annotation_file in os.listdir(breed_annotation_dir):
        ...
        # Extract bounding boxes and write to label file
        ...
        # Add to the lists for splitting
